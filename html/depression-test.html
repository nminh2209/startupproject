...
<head>
    ...
    <link href="/css/depression-design.css" media="screen" rel="stylesheet" type="text/css">
...
<script>
    function calculateDepression() {
        const questions = ["question1", "question2", "question3"]; // Thêm các câu hỏi khác nếu cần
        ...
        Swal.fire({
            ...
            html: `<p>Mức độ trầm cảm: <strong>${depressionLevel}</strong></p>`,
            icon: 'info'
        });
    }
</script>
